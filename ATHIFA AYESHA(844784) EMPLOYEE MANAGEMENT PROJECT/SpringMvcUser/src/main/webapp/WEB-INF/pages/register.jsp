...
<body>
 ...
 <body background="<c:url value="/resources/images/register14.jpg"></c:url>"/>
				...
				<td><fieldset>
						...
						<table width="609" border="0" align="center">
							...
							<tr>
								...
								<td colspan="3"><form:input type="text" name="txt_address"
										id="txt_address" path="address" /></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan="2">Gender</td>
								<td colspan="3"><form:input type="text" name="txt_gender"
										id="txt_gender" path="gender" /></td>
								<td>&nbsp;</td>
							</tr>
